...
/**
 * @date：2015-1-3
 * @describe：无界面短信验证码，可自定义界面。
 */
public class MessageWithoutGUIActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 自定义界面布局可在此替换
		setContentView(R.layout.message_without_main);
